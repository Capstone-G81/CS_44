	      ...
	      <div class="content">
	          ...
	          <div>
				   <table width="100%" border="0">
					    <tr>
					       <td align="center">File Name：${requestScope.xuexi.mingcheng }<hr/></td>
					    </tr>
					    <tr>
					       <td align="center">
					            ${requestScope.xuexi.fujian }
					            &nbsp;&nbsp;&nbsp;
					            <a href="#" onclick="down1('${requestScope.xuexi.fujian }','${requestScope.xuexi.fujian }')" style="font-size: 13px;color: red">Download</a>
					            <hr/>
					       </td>
					    </tr>
					    <tr>
					       <td align="center">Release Time：${requestScope.xuexi.shijian }<hr/></td>
					    </tr>
					</table>
	          </div>
	      </div>
